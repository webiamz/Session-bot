...
# Maine default API_ID = 6 aur API_HASH public wala laga diya hai taaki koi error na aaye
API_ID = int(os.environ.get("API_ID", 6))
API_HASH = os.environ.get("API_HASH", "eb06d4abfb49dc3eeb1aeb98ae0f581e")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")  # Render par Environment me BOT_TOKEN zaroor daalna
...
# 👇 NAYA PYTHON VERSION FIX (Event Loop) 👇
